...
public class CardManager implements CardInterface {
    ...
    @Override
    public void startBluetoothScan(@NonNull Callback callback) {
    ...
    @Override
    public void setReadCardCallback(Callback cardCallback) {
    ...
    @Override
    public void getBtcRawTransaction(Card card, String fees, String toAddress, List<EntUtxoEntity> unSpends, @NonNull Callback callback) {
    ...
    @Override
    public void getEthRawTransaction(Card card, String nonce, String estimateGas, String gasPrice, String toAddress, String value, byte[] data, Callback callback) {
        EthRawTransaction ethRawTransaction = new EthRawTransaction();
        try {
            String rawTransaction = ethRawTransaction.getRawTransaction(card, cardProvider, nonce.getBytes(), gasPrice.getBytes(), estimateGas.getBytes(), ByteUtil.hexStringToBytes(toAddress), value.getBytes(), data);
